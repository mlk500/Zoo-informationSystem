...
public class getMammalController implements Initializable {
	@FXML
	...
	public void get(ActionEvent event) {
		...
		if (Zoo.getInstance().getRealMammal(num) != null) {//find mammal by id and return it
			resultList.getItems().add((Zoo.getInstance().getRealMammal(num).toString()));
		} else
