...
public class getsnackBarController implements Initializable {
	@FXML
	...
	public void get(ActionEvent event) {
		...
		if (Zoo.getInstance().getRealSnackBar(num) != null) {
			resultList.getItems().add((Zoo.getInstance().getRealSnackBar(num).toString()));//find the snackbar by it's id and display it in the list view
		} else
