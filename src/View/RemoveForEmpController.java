...
public class RemoveForEmpController implements Initializable{
	@FXML
    ...
    @FXML
    void removeSnack(ActionEvent event) throws Exception {
    ...
    @FXML
    void removeVisitor(ActionEvent event) throws Exception{
