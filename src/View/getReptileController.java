...
public class getReptileController implements Initializable {
	@FXML
	...
	public void get(ActionEvent event) {
		...
		if (Zoo.getInstance().getRealReptile(num) != null) {//find the reptile by it's id and display it in the list view
			resultList.getItems().add(Zoo.getInstance().getRealReptile(num).toString());
		} else
