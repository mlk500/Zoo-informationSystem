...
public class getSectionController implements Initializable {
	@FXML
	...
	public void get(ActionEvent event) {
		...
		if (Zoo.getInstance().getRealSection(num) != null) {
			resultList.getItems().add((Zoo.getInstance().getRealSection(num).toString()));//find the section by it's id and display it in the list view
		} else
