...
public class getSnackController implements Initializable {
	@FXML
	...
	public void get(ActionEvent event) {
		...
		if (Zoo.getInstance().getRealSnack(num) != null) {
			resultList.getItems().add((Zoo.getInstance().getRealSnack(num).toString()));//find the snack by it's id and display it in the list view
		} else
