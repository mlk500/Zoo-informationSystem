...
public class getEmployeeController implements Initializable{
	@FXML
	...
	public void get(ActionEvent event) {
		...
		if(Zoo.getInstance().getRealEmployee(num) != null) {//return the employee
			resultList.getItems().add(Zoo.getInstance().getRealEmployee(num).toString());
		}
		else
